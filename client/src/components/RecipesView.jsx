...
export default function RecipesView({ pendingPlan, onCancelPending, onOpenRecipe, onQuickAddToPending, onAddRecipe }) {
  ...
  const { recipes } = useRecipes({ dietary: dietaryPrefs, mealType: mealTypeFilter, query: searchQuery })
